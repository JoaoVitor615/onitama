...
export default function PurchaseNotification() {
  ...
  const title = (() => {
    switch (data?.type) {
      ...
      case 'insufficient_coins': return 'Moedas insuficientes';
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 6000, pointerEvents: 'none' }}>
      <div ref={boxRef} style={{
        ...
        background: isInsufficient ? 'linear-gradient(135deg, rgba(180,0,0,0.95), rgba(120,0,0,0.95))' : 'linear-gradient(135deg, rgba(255,140,0,0.95), rgba(255,30,30,0.95))',
        ...
        {isInsufficient ? null : (<div style={{ fontSize: isLoginError ? 36 : 28 }}>✨</div>)}
        <div>
