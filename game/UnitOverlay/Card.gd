...
static var cards: Dictionary[CardType, PackedVector2Array] = { # movement: [[x, y], [x, y]] - piece is [0, 0]
	...
	CardType.ELEPHANT : [Vector2i(-1, 0), Vector2i(-1, 1), Vector2i(1, 0), Vector2i(1, 1)],
	CardType.MANTIS   : [Vector2i(-1, -1), Vector2i(1, -1), Vector2i(0, 1)],
	CardType.BOAR     : [Vector2i(-1, 0), Vector2i(0, -1), Vector2i(1, 0)],
	CardType.FROG     : [Vector2i(-2, 0), Vector2i(-1, 1), Vector2i(1, -1)],
	CardType.GOOSE    : [Vector2i(-1, 0), Vector2i(-1, 1), Vector2i(1, 0), Vector2i(1, -1)],
	CardType.HORSE    : [Vector2i(-1, 0), Vector2i(0, -1), Vector2i(0, 1)],
	CardType.EEL      : [Vector2i(-1, 1), Vector2i(-1, 0), Vector2i(1, -1)],
	CardType.RABBIT   : [Vector2i(1, -1), Vector2i(2, 0), Vector2i(-1, 1)],
	CardType.ROOSTER  : [Vector2i(-1, 1), Vector2i(0, -1), Vector2i(1, 0), Vector2i(1, -1)],
